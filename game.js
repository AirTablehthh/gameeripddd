...
class Game {
    ...
    renderLevel() {
        switch (this.level) {
            case 1:
                this.render("Уровень 1: Вы в классе. Ваш друг находится в другой части колл-центра. Какой путь вы выберете? Введите '1' для обхода, '2' для прямого пути.");
                break;
            case 2:
                this.render("Уровень 2: Вы на коридоре. Слухи о том, что Лариса Юрьевна здесь. Как вы будете действовать? Введите '1' для того, чтобы спрятаться, '2' чтобы продолжать.");
                break;
            case 3:
                this.render("Уровень 3: Вы увидели своего друга. Он в беде. Сохраните его! Введите '1' чтобы помочь ему, '2' чтобы уйти.");
                break;
            case 4:
                this.render("Уровень 4: Лариса Юрьевна заметила вас! Как вы будете реагировать? Введите '1' чтобы сбежать, '2' чтобы притвориться.");
                break;
            case 5:
                this.render("Уровень 5: Вам нужно решить, сливать друга или нет. Введите '1' для предательства, '2' для честности.");
                break;
            case 6:
